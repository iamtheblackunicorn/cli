...
class CommandLineApp {
  ...
  String getArgumentData(List<String> arguments, String argument){
    String argumentData = '';
    for(int i = 0; i < arguments.length; i++){
      if(arguments[i] == argument && this.argumentsDataBase[argument][2] == true){
        int dataIndex = i + 1;
  ...
  void runApp(List<String> arguments){
    ...
    else if(arguments[1] == 'info' || arguments[1] == '--info' || arguments[1] == '-i'){
      this.appInfoMessage();
    }
    else if(arguments[1] == 'version' || arguments[1] == '--version' || arguments[1] == '-v'){
